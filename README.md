...
A Python package based on the deprecated [`pymt5adapter`](https://github.com/nicholishen/pymt5adapter---DEPRECATED). This package provides a simplified way to interact with the MetaTrader 5 terminal for algorithmic trading.
